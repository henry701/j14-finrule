...
@Service
@Order(value = 18000)
public class FinancialFeeTwentyDaysRuleC implements FinancialFeeRule {

    private static final Duration EXCLUSIVE_MIN_DURATION_TO_HANDLE = Duration.ofDays(20);
    private static final Duration INCLUSIVE_MAX_DURATION_TO_HANDLE = Duration.ofDays(30);
    private static final BigDecimal VARIABLE_FEE_FACTOR = new BigDecimal("0.06");
